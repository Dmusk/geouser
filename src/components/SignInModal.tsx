            ...
            <DialogContent className="w-full max-w-sm">
                ...
                <div className="flex flex-col items-center justify-center w-full mt-4 gap-y-4">
                    <div className="flex flex-col items-center justify-center w-full">
                        <Button size="lg" className="w-full text-base font-normal" onClick={handleSignIn}>
                            {isLoading ? (
                        ...
                        <p className="text-sm text-center mt-4">
                            ...
                            <Button size="sm" variant="link" className="px-0 text-sm hover:text-black hover:no-underline" onClick={handleOpenSignUpModal}>
                                Sign up
                            </Button>
                        </p>
                    </div>
